...
def main(args):
    ...
    for behavior in behaviors:
        if event != None:
            ...
            save_file = os.path.join(save_directory, brain_file.split('.')[0] + '_filtered_' + f'{behavior}_{event}_5sec.h5')
        else:
            ...
            save_file = os.path.join(save_directory, brain_file.split('.')[0] + '_filtered_' + f'{behavior}_5sec.h5')
        if os.path.exists(save_file)==False or redo:
            ...
            with h5py.File(brain_dest, 'r') as hf, \
                ...
                if loom_all.shape[0]>0:
                    ...
                    printlog(F"No looms for this fly in {behavior}")
                    continue
