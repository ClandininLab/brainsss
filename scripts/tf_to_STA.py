...
def main(args):
    ...
    range_start=-3000; range_end=3000; steps=100
        ...
        if not os.path.exists(save_file) or redo:
            ...
            if tf_files:
                for file in tf_files:
                    ...
                    if int(fly_val) in flies or str(fly_val) in flies:
                ...
                for file in os.listdir(behave_dir):
                    if event in file and '_tf_' in file and behavior in file and f'_{cc}_' in file:
